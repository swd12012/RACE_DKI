...
Dir1='/dfs6/pub/swdu/microRNA/20211116_RPES_204_211_RACE'

module load subread/2.0.1
gtf='/data/homezvol2/swdu/ref/mm39/mm39.ncbiRefSeq.gtf.gz'
myfile=`cat /dfs6/pub/swdu/microRNA/20211116_RPES_204_211_RACE/samplecoding.txt | cut -f3`
featureCounts -p -T 4 -t exon -g gene_id -Q 30 -F GTF -a $gtf -o $Dir1/data/processed/counts.txt $myfile
